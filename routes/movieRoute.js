...
const { uploadMovie, getAllMovie, deleteMovie, updateMovie, getMovieById, updateRating, postFav, getFavourites, deleteFav, uploadAuthor, getAuthorDetails } = require("../controllers/movieController");
